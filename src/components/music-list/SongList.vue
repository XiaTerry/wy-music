<template>
    <div class="song-list">
        ...
        <ul class="song">
            <li class="song-box"  @click="selectSong(item.id)" v-for="(item,index) in songList" :key="index">
                <div class="img">
...
export default {
    ...
    data () {
        return {
            songList:[],
            img:"http://p1.music.126.net/DCyf-5chgGn1gX3DYRiXEQ==/109951163651258067.jpg"
        }
    },
    created(){
